...
for log in ls:
    ...
    for log in tr_logs:
        ...
        for x in local_task_info:
            ...
            total.append(time)
            try:
                if 'random_matrix' in local_task_info[x]['function']:
                    matrix_gen.append(time)
                else:
                    matrix_mul.append(time)
            except:
                pass
    ...
    for x in global_task_info:
        ...
        total.append(time)
        try:
            if 'random_matrix' in global_task_info[x]['function']:
                matrix_gen.append(time)
            else:
                matrix_mul.append(time)
        except:
